...
from networks.MRFTA.TransBTS_downsample8x_skipconnection import MRFTA
from networks.MRFTA.loss.dice_loss import DC_and_topk_loss
...
parser.add_argument('--batch_size', type=int, default='', help='Batch size for subject input')
parser.add_argument('--crop_sample', type=int, default='', help='Number of cropped sub-volumes for each subject')
...
parser.add_argument('--gpu', type=str, default='', help='your GPU number')
...
if args.network == 'MRFTA':
    _, model = MRFTA(dataset=args.dataset, _conv_repr=True, _pe_type='learned')
...
loss_function = DC_and_topk_loss()
